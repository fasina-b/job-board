...
export default function Footer() {
  return (
    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">CareerSync™</a>. All Rights Reserved.</span>
    </div>
</footer>
  );
}
